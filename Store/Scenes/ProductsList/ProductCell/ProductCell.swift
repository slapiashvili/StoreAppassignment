...
class ProductCell: UITableViewCell {
    ...
    func reload(with product: ProductModel) {
        ...
        //TODO - done
        setImage(from: product.thumbnail) { [weak self] image in
    ...
    private func setImage(from url: String, completion: @escaping (UIImage?) -> Void) {
        NetworkManager.shared.downloadImage(from: url, completion: completion)
    }
